...
var PieChartComponent = forwardRef(function (props, ref) {
  var _ref = props,
      labels = _ref.labels,
  ...
  useEffect(function () {
    deprecationNotice('PieChart', "This component is deprecated and will be removed with v0.10.0. Please use '@ui5/webcomponents-react-charts/lib/next/PieChart' instead.");
  }, []);
  var theme = getTheme();
  var data = useChartData(labels, datasets, colors, theme, true);
  var pieChartDefaultConfig = useMemo(function () {
    return {
      tooltips: {
        callbacks: {
      ...
      plugins: {
        datalabels: {
          ...
          formatter: function formatter(val, context) {
  ...
  var mergedOptions = useMergedConfig(pieChartDefaultConfig, options);
...
var PieChart = withChartContainer(PieChartComponent);
PieChart.defaultProps = _objectSpread({}, ChartBaseDefaultProps);
